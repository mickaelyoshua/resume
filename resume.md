...
Developer with experience in data engineering, back-end APIs and full-stack applications. Proficient in Python, Rust, SQL and Go. Background in ETL pipelines, database modeling, BI dashboards and RESTful/WebSocket services.

**SKILLS**

- **Languages:** Python, SQL, Rust, Go
- **Back-end:** FastAPI, Rocket, Diesel, SQLAlchemy, Gin, RESTful APIs, WebSockets
...
**Data Analysis Intern | Court of Auditors of Paraiba** • June 2022 - June 2024 • Joao Pessoa - PB
...
**Bachelor's Degree in Computer Science** | UNIPE • 2024 - Present

**Electrical Engineering (incomplete)** | IFPB • 2018 - 2024

**Mechanical Technician** | IFPB • 2014 - 2017

**Continuous Learning:** Data Structures & Algorithms, AWS, Rust (Rocket, Tokio) • [View Certificates](https://www.linkedin.com/in/mickaelyoshua/details/certifications/)
